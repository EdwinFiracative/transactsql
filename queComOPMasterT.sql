...
Isnull([MasterTQuantity],0) AS afiMasterTQuantity,
Isnull([MasterTCost],0) AS afiMasterTCost,
...
sum(EMP001_INV.dbo.op2.CMO) AS afiTotCMO,
sum(EMP001_INV.dbo.op2.CCF) AS afiTotCCF
FROM
EMP001_INV.dbo.op2
INNER JOIN
EMP001_INV.dbo.DPTO
...
ataEmp001ProdMaster.LMIN,
sum(ataEmp001ProdMaster2.CANT) as afiTotQuantity,
sum(ataEmp001ProdMaster2.CANT* ataEmp001InvDpto.SMO) AS afiTotSMO,
sum(ataEmp001ProdMaster2.CANT* ataEmp001InvDpto.SCF) AS afiTotSCF
FROM
...
-- **********  Seventh block with the costs of raw material from master estándar
UNION
SELECT
aviLasOps.op,
aviLasOps.CANTP,
...
ataEmp001ProdMaster.MODELO = ataEmp001ProdMaster1.MODELO_MAS
WHERE
ataEmp001ProdMaster1.MODELO_MAS = 'T'
AND
ataEmp001ProdMaster1.cant > 0 
AND
ataEmp001ProdMaster.LMIN > 0
...
CROSS APPLY
(
VALUES ('MasterTQuantity', ataMaster1Resume.afiTotQuantity*aviLasOps.CANTP/ataMaster1Resume.LMIN),('MasterTCost', ataMaster1Resume.afiTotCMP*aviLasOps.CANTP/ataMaster1Resume.LMIN)
)AS ataCosQuantity (cquOrigin, cquValue)

-- **********  Eigth block with the costs of labour form master estándar
...
ataEmp001ProdMaster.MODELO = ataEmp001ProdMaster2.MODELO_MAS
WHERE
ataEmp001ProdMaster2.MODELO_MAS = 'T'
AND
ataEmp001ProdMaster2.cant > 0 
AND
ataEmp001ProdMaster.LMIN > 0
...
VALUES 
(RTRIM(ataMaster2Resume.COD) + ' MO', 'PR.MO.'+ RTRIM(ataMaster2Resume.COD), 'MasterTQuantity',ataMaster2Resume.afiTotQuantity*aviLasOps.CANTP/ataMaster2Resume.LMIN), 
(RTRIM(ataMaster2Resume.COD) + ' MO', 'PR.MO.'+ RTRIM(ataMaster2Resume.COD), 'MasterTCost',ataMaster2Resume.afiTotSMO*aviLasOps.CANTP/ataMaster2Resume.LMIN ),
(RTRIM(ataMaster2Resume.COD) + ' CIF', 'PR.CIF.'+ RTRIM(ataMaster2Resume.COD), 'MasterTQuantity',ataMaster2Resume.afiTotQuantity*aviLasOps.CANTP/ataMaster2Resume.LMIN ), 
(RTRIM(ataMaster2Resume.COD) + ' CIF', 'PR.CIF.'+ RTRIM(ataMaster2Resume.COD), 'MasterTCost',ataMaster2Resume.afiTotSCF*aviLasOps.CANTP/ataMaster2Resume.LMIN )
...
EMP001_INV.dbo.SERVTERC.COD = ataEmp001ProdMaster6.COD
WHERE
ataEmp001ProdMaster6.MODELO_MAS = 'T'
AND
ataEmp001ProdMaster6.cant > 0 
AND
ataEmp001ProdMaster.LMIN > 0
...
(
VALUES 
(left(ltrim(ataMaster6Resume.COD),3), 'MasterTQuantity', ataMaster6Resume.afiTotQuantity*aviLasOps.CANTP/ataMaster6Resume.LMIN),
(left(ltrim(ataMaster6Resume.COD),3), 'MasterTCost', ataMaster6Resume.afiTotValor*aviLasOps.CANTP/ataMaster6Resume.LMIN)
